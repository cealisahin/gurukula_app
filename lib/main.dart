    ...
    return CupertinoTabScaffold(
      tabBar: CupertinoTabBar(
        items: const [
          ...
          BottomNavigationBarItem(
            label: HistoryTab.title,
            icon: HistoryTab.iosIcon,
          ),
          BottomNavigationBarItem(
            label: NotificationTab.title,
            icon: NotificationTab.iosIcon,
          ),
          BottomNavigationBarItem(
      ...
      tabBuilder: (context, index) {
        switch (index) {
          ...
          case 2:
            return CupertinoTabView(
              defaultTitle: HistoryTab.title,
              builder: (context) => const HistoryTab(),
            );
          case 3:
            return CupertinoTabView(
              defaultTitle: NotificationTab.title,
